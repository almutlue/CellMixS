...
To compare different methods summary plots from `compareIntegration` and p-value histograms from `visHist` can be used. Local patterns within single methods can be explored as described above.
