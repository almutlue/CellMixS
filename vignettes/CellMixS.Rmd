...
sce50 <- cms(sce50, k = 20, group = "batch", res_name = "unaligned", n_dim = 3)
head(colData(sce50))

#call cell-specific mixing score for all
sim_list <- lapply(batch_names, function(name){
    sce <- sim_list[[name]]
    sce <- cms(sce, k = 20, group = "batch", res_name = "unaligned", n_dim = 3)
...
sce20 <- cms(sce20, k = 20, group = "batch", 
             dim_red = "MNN", res_name = "MNN", n_dim = 3)
