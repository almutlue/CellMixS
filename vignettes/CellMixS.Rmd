...
sce10[["celltype"]] <- sample(c("CD4+", "CD8+", "CD3", "CD19"), 
                              ncol(sce10), replace = TRUE)
...
visCluster(sce10, metric_var = "cms.unaligned", 
...
sce10 <- cms(sce10, k = 70, group = "batch", 
...
#run cms
sce10 <- cms(sce10, k = 80, group = "batch", 
...
sce_pre_list <- list("1" = sce10[,sce10$batch == "1"], 
                     "2" = sce10[,sce10$batch == "2"], 
                     "3" = sce10[,sce10$batch == "3"])

sce10 <- ldfDiff(sce_pre_list, sce_combined = sce10, 
...
lim_plot <- visMetric(sce10, metric_var = "diff_ldf.limma", 
                      dim_red = "TSNE") 

mnn_plot <- visMetric(sce10, metric_var = "diff_ldf.MNN", 
                      dim_red = "MNN") 
